...
export default function ContactSection({ isStandalone = false }: ContactSectionProps) {
    ...
    return (
        <div className={`w-full bg-background overflow-hidden ${isStandalone ? "flex-grow flex flex-col" : ""}`}>
            {isStandalone && (
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-sm md:text-base text-brand-accent font-light mt-2 leading-relaxed text-justify">
                                Working on something interesting, or hiring? I'd like to hear about it. Message me below.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
            ...
            <section className={`relative w-full px-6 pt-24 pb-24 md:px-[128px] md:pt-[var(--section-pt)] md:pb-[128px] 4k:px-[256px] bg-background-alt overflow-x-hidden z-10 ${isStandalone ? "flex-grow flex items-center justify-center" : ""}`}>
                {/* Slanted Divider */}
                ...
                <div id="contact" className="w-full flex flex-col items-center justify-center text-center relative z-10 scroll-mt-24">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 justify-center items-stretch border-y border-brand-base/10 py-4 md:py-4 mb-4">
                            ...
                            <div className="flex flex-col items-center justify-center px-4 md:px-2 lg:px-4 xl:px-6">
                                <a
                                    href={`https://wa.me/${SITE_CONFIG.phone.replace(/\+/g, "").replace(/\s+/g, "").replace(/-/g, "")}`}
                                    target="_blank"
