...
export default function ProjectsSection() {
    ...
    return (
        <section id="projects" className="min-h-[100dvh] flex flex-col justify-center px-6 max-w-7xl mx-auto relative z-10 py-20 md:py-28 scroll-mt-16 md:scroll-mt-4">
            ...
            >
                {/* <div className="inline-flex px-4 py-2 rounded-full bg-brand-accent/10 border border-brand-accent/20 text-brand-base text-sm font-medium items-center gap-2 mb-4 backdrop-blur-sm">
            ...
            {selectedCategory === "All" && visibleCount < filteredProjects.length && (
                <div className="flex justify-center mb-20">
                    ...
                    >
                        ...
                        {!isLoadingMore && <FaChevronDown className="animate-bounce" />}
                    </Button>
                </div>
            )}
